  ...
  const uploadLogo = async (e, mode) => {
    ...
    await api.post("/settings-whitelabel/logo", formData, {
      onUploadProgress: (event) => {
        ...
        console.log(
          i18n.t("settings.toasts.imageUploadProgress", { progress })
        );
      },
    }).then((response) => {
      ...
      console.error(
        i18n.t("settings.toasts.imageUploadError")
      );
      console.log(err);
    });
  };
            ...
            <>
              ...
              <Grid xs={12} sm={6} md={4} item>
                ...
                <FormControl className={classes.selectContainer}>
                  <TextField
                    ...
                    label={i18n.t("settings.whitelabel.primaryColorDark")}
                    variant="standard"
              ...
              <Grid xs={12} sm={6} md={4} item>
                <FormControl className={classes.selectContainer}>
                  <TextField
                    id="appname-field"
                    label={i18n.t("settings.whitelabel.systemName")}
                    variant="standard"
                    name="appName"
                    value={appName}
              ...
              <Grid xs={12} sm={6} md={4} item>
                <FormControl className={classes.selectContainer}>
                  <TextField
                    ...
                    label={i18n.t("settings.whitelabel.lightLogo")}
                    variant="standard"
              ...
              <Grid xs={12} sm={6} md={4} item>
                <FormControl className={classes.selectContainer}>
                  <TextField
                    ...
                    label={i18n.t("settings.whitelabel.darkLogo")}
                    variant="standard"
              ...
              <Grid xs={12} sm={6} md={4} item>
                <FormControl className={classes.selectContainer}>
                  <TextField
                    ...
                    label={i18n.t("settings.whitelabel.favicon")}
                    variant="standard"
