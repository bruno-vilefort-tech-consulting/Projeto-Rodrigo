...
import { getCurrencySymbol, formatCurrency } from "../CurrencyService";
...
export const sayChatbot = async (
  ...
  // //                           // IMPORTANTE: Se reativar esta funcionalidade, usar formatCurrency() e getCurrencySymbol() do CurrencyService
  // //                           value_pending_corrigida = value_pending.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' });

  // //                           // IMPORTANTE: Substituir R$ hardcoded por await getCurrencySymbol() e usar formatCurrency()
