...
const SettingsCustom = () => {
  ...
  const handleSubmitSchedules = async (data) => {
    ...
    try {
      ...
      toast.success(i18n.t("settings.toasts.schedulesSavedSuccess"));
    } catch (e) {
      toast.error(e);
    }
    setLoading(false);
        ...
        <>
          ...
          <Paper className={classes.mainPaper} elevation={1}>
            ...
            >
              ...
              <Tab label={i18n.t("settings.tabs.timezone")} value={"timezone"} />
            ...
            <Paper className={classes.paper} elevation={0}>
              ...
              <TabPanel className={classes.container} value={tab} name={"timezone"}>
                <TimezoneTab />
              </TabPanel>
            </Paper>
          </Paper>
