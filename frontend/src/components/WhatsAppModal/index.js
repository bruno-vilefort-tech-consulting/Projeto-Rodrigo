...
const WhatsAppModal = ({ open, onClose, whatsAppId }) => {
  ...
  const handleSaveSchedules = async (values) => {
    toast.success(i18n.t("whatsappModal.messages.clickSaveToRegister"));
    setSchedules(values);
  };
            ...
            <Form>
              <Paper className={classes.mainPaper} elevation={1}>
                ...
                >
                  ...
                  <Tab label={i18n.t("whatsappModal.tabs.chatbot")} value={"chatbot"} />
                  <Tab label={i18n.t("whatsappModal.tabs.assessments")} value={"nps"} />
                  <Tab label={i18n.t("whatsappModal.tabs.defaultFlow")} value={"flowbuilder"} />
              ...
              <Paper className={classes.paper} elevation={0}>
                ...
                {showIntegrations && (
                  <>
                    ...
                    >
                      <DialogContent>
                        <h3>{i18n.t("whatsappModal.flowBuilder.welcomeFlow")}</h3>
                        <p>{i18n.t("whatsappModal.flowBuilder.welcomeFlowDescription")}
                        </p>
                        <FormControl
                          variant="outlined"
                          margin="dense"
                      ...
                      <DialogContent>
                        <h3>{i18n.t("whatsappModal.flowBuilder.defaultResponseFlow")}</h3>
                        <p>{i18n.t("whatsappModal.flowBuilder.defaultResponseFlowDescription")}
