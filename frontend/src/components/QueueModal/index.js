...
const QueueSchema = Yup.object().shape({
  name: Yup.string()
    .min(2, i18n.t("queueModal.validations.tooShort"))
    .max(50, i18n.t("queueModal.validations.tooLong"))
    .required(i18n.t("queueModal.validations.required")),
  color: Yup.string().min(3, i18n.t("queueModal.validations.tooShort")).max(9, i18n.t("queueModal.validations.tooLong")).required(),
  greetingMessage: Yup.string(),
  chatbots: Yup.array()
    .of(
      Yup.object().shape({
        name: Yup.string().min(4, i18n.t("queueModal.validations.tooShort")).required(i18n.t("queueModal.validations.required")),
      })
    )
    .required(i18n.t("queueModal.validations.mustHaveFriends")),
});
...
const QueueModal = ({ open, onClose, queueId, onEdit }) => {
  ...
  const handleSaveSchedules = async (values) => {
    toast.success(i18n.t("queues.toasts.clickToSave"));
    setSchedules(values);
    setTab(0);
  };
                ...
                <DialogContent dividers>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <MenuItem value="2">{i18n.t("queueModal.form.timeOptions.minutes2")}</MenuItem>
                      <MenuItem value="5">{i18n.t("queueModal.form.timeOptions.minutes5")}</MenuItem>
                      <MenuItem value="10">{i18n.t("queueModal.form.timeOptions.minutes10")}</MenuItem>
                      <MenuItem value="15">{i18n.t("queueModal.form.timeOptions.minutes15")}</MenuItem>
                      <MenuItem value="30">{i18n.t("queueModal.form.timeOptions.minutes30")}</MenuItem>
                      <MenuItem value="45">{i18n.t("queueModal.form.timeOptions.minutes45")}</MenuItem>
                      <MenuItem value="60">{i18n.t("queueModal.form.timeOptions.minutes60")}</MenuItem>
                    </Field>
                  </div>
                  <div>
                    {showIntegrations && (
                      ...
                      >
                        ...
                        >
                          <MenuItem value={""} >{i18n.t("queueModal.general.none")}</MenuItem>
                                        ...
                                        {isGreetingMessageEdit !== index ? (
                                          ...
                                          >
                                            <Typography
                                              ...
                                              variant="body1"
                                            >
{i18n.t("queueModal.general.message")}
                                            </Typography>
