  ...
  return (
    <>
      <Grid spacing={3} container>
            ...
            <FormControl className={classes.selectContainer}>
              ...
              >
                <MenuItem value={"disabled"}>
                  {i18n.t("settings.settingsConfig.options.disabled")}
                </MenuItem>
                <MenuItem value={"enabled"}>
                  {i18n.t("settings.settingsConfig.options.enabled")}
                </MenuItem>
              </Select>
              <FormHelperText>
                {loadingUserCreation &&
                  i18n.t("settings.settingsConfig.options.updating")}
              </FormHelperText>
            </FormControl>
          </Grid>
          : null}
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="ratings-label">{i18n.t("settings.settingsConfig.options.evaluations")}</InputLabel>
            <Select
            ...
            <FormHelperText>
              {loadingUserRating && i18n.t("settings.settingsConfig.options.evaluations")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingScheduleType && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingSendGreetingAccepted && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingUserRandom && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingSettingsTransfTicket && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="schedule-type-label">{i18n.t("settings.settingsConfig.options.chatBotType")}</InputLabel>
            <Select
              labelId="schedule-type-label"
              value={chatBotType}
              onChange={async (e) => {
            ...
            >
              <MenuItem value={"text"}>{i18n.t("settings.chatBotType.text")}</MenuItem>
              {/* <MenuItem value={"button"}>{i18n.t("settings.settingsConfig.options.buttons")}</MenuItem>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingAcceptCallWhatsapp && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingSendSignMessage && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingSendGreetingMessageOneQueues && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingSendQueuePosition && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingSendFarewellWaitingTicket && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingAcceptAudioMessageContact && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="enableLGPD-label"> {i18n.t("settings.settingsConfig.options.enableLGPD")}</InputLabel>
            <Select
            ...
            >
              <MenuItem value={"disabled"}>{i18n.t("settings.settingsConfig.options.disabled")}</MenuItem>
              <MenuItem value={"enabled"}>{i18n.t("settings.settingsConfig.options.enabled")}</MenuItem>
            </Select>
            <FormHelperText>
              {loadingEnableLGPD && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="requiredTag-label"> {i18n.t("settings.settingsConfig.options.requiredTag")}</InputLabel>
            <Select
            ...
            <FormHelperText>
              {loadingRequiredTag && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="closeTicketOnTransfer-label"> {i18n.t("settings.settingsConfig.options.closeTicketOnTransfer")}</InputLabel>
            <Select
            ...
            >
              <MenuItem value={false}>{i18n.t("settings.settingsConfig.options.disabled")}</MenuItem>
              <MenuItem value={true}>{i18n.t("settings.settingsConfig.options.enabled")}</MenuItem>
            </Select>
            <FormHelperText>
              {loadingCloseTicketOnTransfer && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="showNotificationPending-label"> {i18n.t("settings.settingsConfig.options.showNotificationPending")}</InputLabel>
            <Select
            ...
            <FormHelperText>
              {loadingShowNotificationPending && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid>
        {/* <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="DirectTicketsToWallets-label"> {i18n.t("settings.settingsConfig.options.DirectTicketsToWallets")}</InputLabel>
            <Select
            ...
            <FormHelperText>
              {loadingDirectTicketsToWallets && i18n.t("settings.settingsConfig.options.updating")}
            </FormHelperText>
          </FormControl>
        </Grid> */}
      </Grid>
      ...
      {enableLGPD === "enabled" && (
        <>
          ...
          <Grid spacing={1} container>
            ...
            <Grid xs={12} sm={6} md={4} item>
              <FormControl className={classes.selectContainer}>
                <InputLabel id="lgpdDeleteMessage-label">{i18n.t("settings.settingsConfig.LGPD.obfuscateMessageDelete")}</InputLabel>
                <Select
                ...
                >
                  <MenuItem value={"disabled"}>{i18n.t("settings.settingsConfig.LGPD.disabled")}</MenuItem>
                  <MenuItem value={"enabled"}>{i18n.t("settings.settingsConfig.LGPD.enabled")}</MenuItem>
                </Select>
                <FormHelperText>
                  {loadingLGPDDeleteMessage && i18n.t("settings.settingsConfig.options.updating")}
                </FormHelperText>
              </FormControl>
            </Grid>
            ...
            <Grid xs={12} sm={6} md={4} item>
              <FormControl className={classes.selectContainer}>
                ...
                <FormHelperText>
                  {loadingLGPDConsent && i18n.t("settings.settingsConfig.options.updating")}
                </FormHelperText>
              </FormControl>
            </Grid>
            ...
            <Grid xs={12} sm={6} md={4} item>
              <FormControl className={classes.selectContainer}>
                ...
                <FormHelperText>
                  {loadingLGPDHideNumber && i18n.t("settings.settingsConfig.options.updating")}
                </FormHelperText>
              </FormControl>
            </Grid>
          </Grid>
