...
// ---------------- theme helpers ----------------
const getPaletteMode = (theme) => theme?.palette?.mode ?? theme?.palette?.type ?? "light";
const labelColor = (theme, isActive, iconColor) =>
  isActive ? iconColor : getPaletteMode(theme) === "dark" ? "#FFF" : "#666";
        ...
        <ListItem
          ...
          sx={{
            ...
            "& .MuiListItemText-primary": {
              color: `${labelColor(theme, isActive, iconStyle.color)} !important`,
            },
          }}
        >
          {icon && (
    ...
    !collapsed && (
      <Typography
        sx={{
          ...
          lineHeight: 1,
          letterSpacing: "0.5px",
          color: getPaletteMode(theme) === "dark" ? "rgba(255,255,255,0.7)" : "#888",
        }}
      >
        {children}
      </Typography>
