...
const CampaignModal = ({
  ...
  const initialState = {
    ...
    //whatsappId: "",
    contactListId: "",
    tagListId: i18n.t("campaigns.common.none"),
    companyId,
    statusTicket: "closed",
    openTicket: "disabled"
  };
  ...
  const renderMessageField = (identifier) => {
    return (
      <Field
        ...
        multiline={true}
        variant="outlined"
        helperText={i18n.t("campaigns.modal.helpText")}
              ...
              <DialogContent dividers>
                <Grid spacing={2} container>
                  ...
                  <Grid xs={12} md={4} item>
                    ...
                    >
                      ...
                      <Field
                        ...
                        disabled={!campaignEditable}
                      >
                        <MenuItem value={false}>{i18n.t("campaigns.common.disabled")}</MenuItem>
                        <MenuItem value={true}>{i18n.t("campaigns.common.enabled")}</MenuItem>
                      </Field>
                    </FormControl>
                  </Grid>
                  <Grid xs={12} md={4} item>
                    ...
                    >
                      ...
                      <Field
                        ...
                        disabled={!campaignEditable}
                      >
                        <MenuItem value="">{i18n.t("campaigns.common.none")}</MenuItem>
                        {contactLists &&
                  ...
                  <Grid xs={12} item>
                    ...
                    >
                      <Tab label={i18n.t("campaigns.modal.tabLabels.msg1")} index={0} />
                      <Tab label={i18n.t("campaigns.modal.tabLabels.msg2")} index={1} />
                      <Tab label={i18n.t("campaigns.modal.tabLabels.msg3")} index={2} />
                      <Tab label={i18n.t("campaigns.modal.tabLabels.msg4")} index={3} />
                      <Tab label={i18n.t("campaigns.modal.tabLabels.msg5")} index={4} />
                    </Tabs>
