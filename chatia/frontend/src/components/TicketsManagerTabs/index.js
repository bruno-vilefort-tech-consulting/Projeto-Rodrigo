          ...
          <Grid item>
            <Can
              ...
              yes={() => (
                <Badge
                  ...
                  badgeContent={i18n.t("ticketsResponsive.filter.all")}
            ...
            {tab !== "closed" && tab !== "search" && (
              <Badge
                ...
                badgeContent={!sortTickets ? i18n.t("ticketsResponsive.sort.ascending") : i18n.t("ticketsResponsive.sort.descending")}
                classes={{ badge: classes.tabsBadge }}
              >
                <ToggleButton
