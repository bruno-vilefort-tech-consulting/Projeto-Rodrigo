      ...
      return setNodes((old) => {
        return [
          ...old,
          {
            id: geraStringAleatoria(30),
            position: { x: posX, y: posY },
            data: { label: i18n.t("flowBuilderConfig.messages.interval", { seconds: data.sec }), sec: data.sec },
            type: "interval",
          },
        ];
      });
  ...
  const actions = [
    {
      ...
      name: i18n.t("flowBuilderConfig.nodes.start"),
      type: "start",
    },
    {
      icon: (
    ...
    },
    {
      ...
      name: i18n.t("flowBuilderConfig.nodes.openai"),
      type: "openai",
    },
    {
      icon: (
      ...
      {!loading && (
        ...
        >
          ...
          >
            ...
            >
              {i18n.t("flowBuilderConfig.messages.rememberSave")}
            </Typography>
          </Stack>
