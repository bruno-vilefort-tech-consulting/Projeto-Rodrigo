...
const CampaignsPhrase = () => {
  ...
  const handleDeleteCampaign = async campaignId => {
    try {
      ...
      toast.success(i18n.t("campaignsPhrase.phraseDeleted"));
      getCampaigns()
    } catch (err) {
      toastError(err);
    }
              ...
              <Grid xs={6} sm={6} item>
                ...
                >
                  <Stack direction={"row"} gap={1}>
                    <AddCircle />
                    {i18n.t("campaignsPhrase.addCampaign")}
                  </Stack>
                </Button>
              </Grid>
            </Grid>
        ...
        <Stack>
          <Grid container style={{ padding: "8px" }}>
            <Grid item xs={4} style={{ color: colorTopTable() }}>
              {i18n.t("campaignsPhrase.table.name")}
            </Grid>
            <Grid item xs={4} style={{ color: colorTopTable() }} align="center">
              {i18n.t("campaignsPhrase.table.status")}
            </Grid>
                ...
                >
                  ...
                  <Grid item xs={4} align="center" style={{ color: "#ededed" }}>
                    <Stack justifyContent={"center"} height={"100%"}>
                      {flow.status ? i18n.t("campaignsPhrase.table.active") : i18n.t("campaignsPhrase.table.inactive")}
                    </Stack>
                  </Grid>
