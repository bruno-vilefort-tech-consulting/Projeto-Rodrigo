  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (!planConfigs.plan.useCampaigns) {
        toast.error(i18n.t("campaigns.noPermission"));
        setTimeout(() => {
          history.push(`/`)
        }, 1000);
      }
                  ...
                  <>
                    {campaigns.map((campaign) => (
                      <TableRow key={campaign.id}>
                        ...
                        <TableCell align="center">
                          {campaign.confirmation ? i18n.t("campaigns.common.enabled") : i18n.t("campaigns.common.disabled")}
                        </TableCell>
                        <TableCell align="center">
                          {campaign.status === "EM_ANDAMENTO" && (
                            <IconButton
                              onClick={() => cancelCampaign(campaign)}
                              title={i18n.t("campaigns.buttons.stopCampaign")}
                              size="small"
                            >
