...
const AllConnections = () => {
  ...
  const loadCompanies = async () => {
    ...
    try {
      ...
      toast.error(i18n.t("allConnections.errors.loadCompanies"));
    }
            ...
            <MainHeader>
              <Stack>
                ...
                <Typography style={{ marginTop: "-10px", marginLeft: "10px" }} variant="caption" color="textSecondary">
                  {i18n.t("allConnections.subtitle")}
                </Typography>
              </Stack>
                    ...
                    <React.Fragment>
                      <Menu {...bindMenu(popupState)}>
                        ...
                        >
                          ...
                          />
                          {i18n.t("allConnections.channels.whatsapp")}
                        </MenuItem>
                        <FacebookLogin
                          ...
                          render={renderProps => (
                            <MenuItem onClick={renderProps.onClick}>
                              ...
                              />
                              {i18n.t("allConnections.channels.facebook")}
                            </MenuItem>
                          )}
                        />
                        ...
                        <FacebookLogin
                          ...
                          render={renderProps => (
                            <MenuItem onClick={renderProps.onClick}>
                              ...
                              />
                              {i18n.t("allConnections.channels.instagram")}
                            </MenuItem>
                          )}
                        />
                      </Menu>
                  ...
                  <TableHead className={classes.TableHead}>
                    <TableRow style={{ color: "#fff" }}>
                      <TableCell style={{ color: "#fff" }} align="center">
                        {i18n.t("allConnections.table.client")}
                      </TableCell>
                      <TableCell style={{ color: "#fff" }} align="center">
                        {i18n.t("allConnections.table.connectedConnections")}
                      </TableCell>
                      <TableCell style={{ color: "#fff" }} align="center">
                        {i18n.t("allConnections.table.disconnectedConnections")}
                      </TableCell>
                      <TableCell style={{ color: "#fff" }} align="center">
                        {i18n.t("allConnections.table.totalConnections")}
                      </TableCell>
                      {user.profile === "admin" && (
                        <TableCell style={{ color: "#fff" }} align="center">
                    ...
                    {loadingWhatsapp ? (
                      ...
                      <>
                        ...
                        <TableRow className={classes.TableHead}>
                          <TableCell style={{ color: "#fff" }} align="center">{i18n.t("allConnections.table.total")}</TableCell>
                          <TableCell style={{ color: "#fff" }} align="center">
                            {whats?.length &&
