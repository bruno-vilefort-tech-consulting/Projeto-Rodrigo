...
export PATH=/root/.cursor-server/cli/servers/Stable-a84f941711ad680a635c8a3456002833186c4840/server/bin/remote-cli\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/games\:/usr/local/games\:/snap/bin
